...
export default function MarketingAutomationLogsPage() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-foreground leading-[1.35]">Automation Logs</h1>
          <p className="text-sm text-muted-foreground mt-1">Track sent messages, opens, clicks, responses</p>
        </div>
