...
export default function MarketingDripsPage() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-foreground leading-[1.35]">Drips</h1>
          <p className="text-sm text-muted-foreground mt-1">Create email sequence campaigns (multi-step automated sequences)</p>
        </div>
