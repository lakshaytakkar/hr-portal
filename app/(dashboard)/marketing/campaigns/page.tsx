...
export default function MarketingCampaignsPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-semibold text-foreground leading-[1.35]">Campaigns</h1>
        <p className="text-sm text-muted-foreground mt-1">Multi-channel campaign management (email + WhatsApp)</p>
      </div>
