...
export default function FinanceReportsPage() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-foreground leading-[1.35]">Financial Reports</h1>
          <p className="text-sm text-muted-foreground mt-1">Generate and view financial reports and analytics</p>
        </div>
