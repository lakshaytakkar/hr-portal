...
export default function FinanceExpensesPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h1 className="text-xl font-semibold text-foreground leading-[1.35]">Expenses</h1>
        <p className="text-sm text-muted-foreground mt-1">Track and manage company expenses</p>
      </div>
