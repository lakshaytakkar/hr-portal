...
export default function AnalyticsDomainsPage() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-foreground leading-[1.35]">Domains</h1>
          <p className="text-sm text-muted-foreground mt-1">Manage domains, track expiry dates, DNS settings</p>
        </div>
